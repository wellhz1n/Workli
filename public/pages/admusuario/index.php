<div class="col p-0 m-0">
    ...
    <div class=" float-right mt-1 ml-3 p-1 pr-4 " style="z-index:200">
        ...
        <button class="btn  btn-green" id="btnEditar"><i class="fas fa-edit mr-1"></i>Editar</button>
        <button class="btn  btn-green" id="btnVisualizar"><i class="fas fa-eye mr-1"></i>Visualizar</button>
        <button class="btn btn-danger" id="btnRemover"><i class="fas fa-trash mr-1"></i>Remover</button>
        <button class="btn  btn-green" id="btnSalvar" hidden><i class="fas fa-save mr-1"></i>Salvar</button>
    ...
    <wm-container :campos="dataVue.gridCamposUsuario" id="gridUsuario" :opcoes="dataVue.gridUsuario">
    </wm-container>
