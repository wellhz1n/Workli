                        ...
                        <div class="m-1 p-1">
                            ...
                            <div class="d-flex w-100 justify-content-center">
                                <div v-if="dataVue.selecionadoController.situacao != 3" class="d-contents" style="display:flex;flex-direction: column; width: 90%;justify-content: center;align-items: center;margin-top: 7px;">
                                    ...
                                    <a v-if="dataVue.selecionadoController.situacao  == 4" @click="(event)=>{dataVue.AvaliacaoModalController = true}" class="botaoAtalho mb-2" style="color: white !important;cursor: pointer !important;"><i class="fas fa-star" aria-hidden="true"></i> Avaliar Funcionário</a>
